...
## GENERAL CHARACTERIZATION OF THE 2021 AND 2022 EDITIONS
  ...
  In response to the Brazilian lack of training in computational skills among bioscientists, we developed an initiative to teach introductory programming and provide participants with the ability to handle and analyze large biological datasets using Python. The Brazilian Python Workshop for Biological Data was first held in 2017 and was previously described in Zuvanov et al., 2021 [[1]](https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1009534).
  
  The 2020 edition of the course, the first to be offered online, comprised two modules: one covering basic programming concepts such as variables, data types, loops, and conditional statements, and another focused on data manipulation and visualization with libraries including Biopython, Matplotlib, NumPy, and Pandas.
  
  Building on this structure, the 2021 and 2022 editions were held online and introduce data collection, organization, and analysis through practical sessions in a participatory live-coding format [[2]](https://doi.org/10.1371/journal.pcbi.1008090). Both workshops took place around five days of immersive Python learning, with a one-day break for exercises [(S1 Table and S2 Table)](https://zenodo.org/records/14906909). They combined introductory sessions covering language syntax and hands-on activities involving Python coding and programming logic. Lectures were developed using interactive Jupyter notebooks hosted on Google Collaboratory (https://colab.research.google.com/). During problem-solving and presentations, instructors actively wrote and explained the code live, while participants were encouraged to write, document, and run their own code independently and concurrently. The detailed schedule for both editions are available in the [Zenodo repository](https://zenodo.org/records/14906909).

### Workshop Structure
    
  In 2021, the practical sessions involved the manipulation of tabulated data, exploratory analysis with graphs, exploration of epidemiological data [[3]](https://doi.org/10.1016/S1473-3099(20)30120-1), and biological diversity. In 2022, the practical sessions involved manipulation of tabulated data, exploratory analysis with graphs, introduction to the manipulation of biological sequences, and exploration of size measurements for three species of penguins observed on different islands in Antarctica [[4]](https://doi.org/10.1371/journal.pone.0090081). In both years, the third day of the workshop was reserved for required activities. In 2021, individual and group activities were required, whereas in 2022, only group activities were mandatory. Individual activities have become optional to reduce the workload on participants. A daily seminar related to the applied use of the Python language was given. On the fifth day, a special session called Flash Talks was held with selected participants for short presentations on their research, followed by a discussion on how the Python language could be applied to their own studies. 
...
### Characterization of registrations
...
1. Zuvanov L, Basso Garcia AL, Correr FH, Bizarria R Jr, Filho APdC, et al. The experience of teaching introductory programming skills to bioscientists in Brazil. PLOS Computational Biology. 2021;17(11): e1009534. https://doi.org/10.1371/journal.pcbi.1009534
2.  Nederbragt A, Harris RM, Hill AP, Wilson G. Ten quick tips for teaching with participatory live coding. PLOS Comput Biol. 2020;16: e1008090. doi: https://doi.org/10.1371/journal.pcbi.1008090
3. 	Dong E, Du H, Gardner L. An interactive web-based dashboard to track COVID-19 in real time. Lancet Infect Dis. 2020;20: 533–534. doi: https://doi.org/10.1016/S1473-3099(20)30120-1
4. 	Gorman KB, Williams TD, Fraser WR. Ecological Sexual Dimorphism and Environmental Variability within a Community of Antarctic Penguins (Genus Pygoscelis). Chiaradia A, editor. PLoS ONE. 2014;9: e90081. doi: https://doi.org/10.1371/journal.pone.0090081
